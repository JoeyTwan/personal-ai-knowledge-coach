...
**过一条，收一条。** 每条都不是聊两句就算过。AI 先讲给你听，再要求你用自己的话讲一遍，并且举一个例子。讲不清楚或者例子举错，它会指出错在哪个具体的地方，换个角度重讲一次，然后接着问。答得上来才收录；来回三轮还接不住，它如实记成待复习，不硬撑。

**AI 知识共创。** 你也可以直接讲一段想法，AI 不会替你总结收下，它先追问。追问的是那些你以为懂了、其实一句话说不清的地方。来回几轮，等你把这件事讲明白了，它才整理成结构化知识，呈给你确认。确认这一步是你的，它不替你决定。
...
**逐条过关**：讲给你听，再要你讲回来。答对了指出对在哪，答错了指出错在哪，补充的内容会标出来源。
