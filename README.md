...
答错了不会把同一段话再说一遍，而是退一级换个更简单的问法，从另一个角度讲给你听。选项里没有你想说的那一个，就点「都不对，我说说我的想法」，自己写一句当答案，不算答错。来回三轮接不住，如实记成待复习，不硬撑。

举例是加分项，不是门槛。收录前想举一个自己工作里的例子就举，不想举也能收。AI 补充的背景会标出来源，你自己说的那一句会原样进草稿，不被改写成书面语。

**AI 知识共创。** 你也可以直接讲一段想法，AI 不会替你总结收下，它先追问。第一句不是它的理解，而是它把听到的主题复述回来跟你确认，确认对了才往下聊。追问的是那些你以为懂了、其实一句话说不清的地方，一样是一张卡一张卡地给，点选为主。

**什么时候收录，由你说了算。** AI 聊到一半不会自己把卷子收走。你觉得聊透了，点「聊透了，整理成知识」，或者直接说一句「收录吧」，它才把这段讨论整理成草稿。草稿出来也不强制你收，可以改、可以继续聊、可以放弃。收录之后对话不中断，接着问别的问题也行。
...
新收录的知识不会从零起步。刚讨论完，理解这一维本该是热的，所以讨论收录的知识综合掌握在六成上下，稳定度只给很低的一档。稳定是唯一挣不出来速成的维度，它只能靠间隔复习一次次答对慢慢积起来，这也是整套打分里最后一道防水的闸。此后自测答对往上走，答错往下掉。
