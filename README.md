...
**AI 知识共创。** 你贴一段原文或者讲一段想法，AI 不会直接替你总结收下，它先追问。追问的是那些你以为懂了、其实一句话说不清的地方。来回几轮，等你把这件事讲明白了，它才整理成结构化知识，呈给你确认。确认这一步是你的，它不替你决定。
...
Backend（Fastify + TypeScript）
        │
        ├── Service 层
        │     Knowledge / Relation / Cocreation / Coach
        │     Recall / Cognition / Profile / Scheduler
        │
...
| AI | DeepSeek API（OpenAI 兼容协议，可替换任意同协议模型） |
